...
describe('Tutorial part 6', () => {
  ...
  function getPageElts() {
    ...
    return {
      ...
      appHeroes: element(by.css('app-root app-advisories')),
      allHeroes: element.all(by.css('app-root app-advisories li')),
      selectedHeroSubview: element(by.css('app-root app-advisories > div:last-child')),

      heroDetail: element(by.css('app-root app-advisory-list > div')),
  ...
  describe('Heroes tests', () => {
    ...
    it('can switch to Heroes view', () => {
      ...
      expect(page.allHeroes.count()).toEqual(10, 'number of advisories');
    });
    ...
    it(`deletes ${newHeroName} from Heroes list`, async () => {
      ...
      expect(page.appHeroes.isPresent()).toBeTruthy();
      expect(page.allHeroes.count()).toEqual(9, 'number of advisories');
    ...
    it(`adds back ${targetHero.name}`, async () => {
      ...
      expect(heroesAfter.length).toEqual(numHeroes + 1, 'number of advisories');

      expect(heroesAfter.slice(0, numHeroes)).toEqual(heroesBefore, 'Old advisories are still there');
